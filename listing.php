...
<div class="container listing-container my-3">
	...
	<div class="row">		
									...
									<div class="card card-body">
										...
										<div class="collapse" id="sub-list-cat-cinema"> 
											<div class="card card-body sub-cat-card-body">
												...
												<a href="#"><p>Film Festivals &amp Organizations</p></a>

												<a href="#"><p>Movie Theaters</p></a>

												<a href="#"><p>Dance Groups &amp Organizations</p></a>

												<a href="#"><p>Family Entertainment Centers</p></a>
									...
									<div class="card card-body">
										...
										<div class="collapse" id="sub-list-cat-air-travel"> 
											<div class="card card-body sub-cat-card-body">
												...
												<a href="#"><p> Airlines </p></a>

												<a href="#"><p> Airports </p></a>

												<a href="#"><p> Helicopter Charters </p></a>

												<a href="#"><p>Campgrounds</p></a>

												<a href="#"><p>Cruises</p></a>

												<a href="#"><p>Ferries</p></a>
		...
		<!-- listing -->
		<div class="col-12 col-md-8 col-lg-9 listing-services">			
			
			<!-- hotel -->
			<div class="jumbotron listing-services-jumbotron p-0 wow pulse">
				<div class="row">

					<img src="img/listing/listing-hotel.jpg" class="col-12 col-sm-6">

					<div class="col-12 col-sm-6 listing-services-text">				
						<h5>
							<i class="far fa-folder-open"></i> Hotel
							<div class="heart-icon">
								<a href="#"><i class="far fa-heart"></i></a>
							</div>
						</h5>
						<a href="#"><h3>Best Hotel Room</h3></a>
						<div class="row">
			...
			<div class="jumbotron listing-services-jumbotron p-0 wow pulse">
				<div class="row">
					...
					<img src="img/listing/listing-cab.jpg" class="col-12 col-sm-6">

					<div class="col-12 col-sm-6 listing-services-text">				
						<h5>
							<i class="far fa-folder-open"></i> Cab
							<div class="heart-icon">
								<a href="#"><i class="far fa-heart"></i></a>
							</div>
						</h5>
						<a href="#"><h3>Go Cab</h3></a>
						<div class="row">
							<div class="col-12 col-md-6">
								<a href="#">
									<p>
			...
			<div class="jumbotron listing-services-jumbotron p-0 wow pulse">
				<div class="row">
					...
					<img src="img/listing/listing-world.jpg" class="col-12 col-sm-6">

					<div class="col-12 col-sm-6 listing-services-text">				
						<h5>
							<i class="far fa-folder-open"></i> Travel
							<div class="heart-icon">
								<a href="#"><i class="far fa-heart"></i></a>
							</div>
						</h5>
						<a href="#"><h3>Travel World</h3></a>
						<div class="row">
							<div class="col-12 col-md-6">
								<a href="#">
									<p>
